...
: std::bool_constant<std::is_integral_v<T> and sizeof(T) == 1> {
};
...
template<typename T>
struct is_iter_value_1byte_integral<
 T,
...
template<typename T>
constexpr auto is_iter_value_1byte_integral_v =
 is_iter_value_1byte_integral<T>::value;
